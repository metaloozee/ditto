...
Generated on 2026-06-24. Updated on 2026-07-02 with plans 018–020 (the three-phase Pi-SDK rewrite from `docs/pi-sdk-session-broker-prd.md`) added against commit `55b6151`. Plans 015-017 were reconciled on 2026-07-01 against `e3d5209`. The earlier Flue plan 016 is rejected and retained only as the historical record of the abandoned Flue approach; use plan 017 for the direct Pi Durable Object session-broker foundation, plan 018 for the SDK runner + contract module, plan 019 for the DO rewire, and plan 020 for hardening. Execute in the order below unless dependencies say otherwise. Each executor: read the plan fully before starting, honor its STOP conditions, and update your row when done.
...
| 019 | Rewire the WorkspaceSessionBroker DO to launch the Pi SDK runner | P1 | L | 018 | TODO |
| 020 | Harden the runner↔broker path (redaction, ready timeout, stale-runner cleanup) | P2 | M | 018, 019 | TODO |
