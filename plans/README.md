...
plans should start from that digest. The worktree still holds the uncommitted
spec at
`/home/ayan/.grok/worktrees/ayan-ditto/subagent-01a01ffd-4672-7ee0-8e6c-8ef3f79c38e8`.
Copy it into this workspace before running plan 002 or 004.
...
| [002](002-lock-pi-resource-loading.md) | TODO | 001 | Normal chat loads only the image-owned Ditto extension and no repository resources. |
